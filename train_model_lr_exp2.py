...
if __name__ == '__main__':
    ...
    # 结果保存到txt文件
    with open(f'experiment2_res\\lr_{band_name}_{feature_name}__results.txt', 'w') as f:
        # 预测标签，预测概率，真实标签写入文件
    ...
    # plt.tight_layout()
    # # 保存为dpi300的tif
    # plt.savefig(f'experiment2_res\\lr_{band_name}_{feature_name}__confusion_matrix.tif', dpi=300)
    # # 绘制ROC曲线
    ...
    # plt.tight_layout()
    # # 保存为dpi300的tif
    # plt.savefig(f'experiment2_res\\lr_{band_name}_{feature_name}__ROC_curve.tif', dpi=300)
    # # 绘制PR曲线
    # plt.figure(figsize=(10, 6))
    ...
    # plt.tight_layout()
    # # 保存为dpi300的tif
    # plt.savefig(f'experiment2_res\\lr_{band_name}_{feature_name}__PR_curve.tif', dpi=300)
