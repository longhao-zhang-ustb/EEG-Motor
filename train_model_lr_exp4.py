...
if __name__ == '__main__':
    ...
    # 保存prob_true, prob_pred, brier
    np.save(f'experiment4_res\\prob_true_{band_name}.npy', prob_true)
    np.save(f'experiment4_res\\prob_pred_{band_name}.npy', prob_pred)
    np.save(f'experiment4_res\\brier_{band_name}.npy', brier)
    # 绘制
    ...
    plt.show()
    # 保存图片
    # plt.savefig(f'experiment4_res\\lr_calibration_curve_{band_name}.tif', dpi=300, bbox_inches='tight')
